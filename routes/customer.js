...
router
  ...
  .post("/block-user/:id",authController.authenticate, customerController.handleBlockUser)
  .get("/get-all-blocked-users",authController.authenticate, customerController.getAllBlockedUsers)
  .delete("/unblock-user/:id",authController.authenticate, customerController.handleUnblockUser)
  .post("/get-collection-name",authController.authenticate, customerController.getCollectionName)
  .get("/get-reports",authController.authenticate, customerController.getReports)
  .delete("/delete-report/:id",authController.authenticate, customerController.handleDeleteReport);
